...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/community/slug/*").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/post/*").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/user/slug/*").permitAll()
                ...
                .antMatchers(HttpMethod.PUT, "/api/v1/user/*/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.PUT, "/api/v1/user/**/**/**").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.DELETE, "/api/v1/user/*").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.DELETE, "/api/v1/user/*/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.DELETE, "/api/v1/user/**/**/**").access("hasRole('ROLE_USER')")

                .antMatchers( HttpMethod.GET, "/api/v1/community").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.GET, "/api/v1/community/*").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.GET, "/api/v1/community/*/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.GET, "/api/v1/community/**/**/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.POST, "/api/v1/community").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.POST, "/api/v1/community/*").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.POST, "/api/v1/community/*/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.POST, "/api/v1/community/**/**/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.PUT, "/api/v1/community").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.PUT, "/api/v1/community/*").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.PUT, "/api/v1/community/*/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.PUT, "/api/v1/community/**/**/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.DELETE, "/api/v1/community").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.DELETE, "/api/v1/community/*").access("hasRole('ROLE_USER')")
                .antMatchers(HttpMethod.DELETE, "/api/v1/community/*/**").access("hasRole('ROLE_USER')")
                .antMatchers( HttpMethod.DELETE, "/api/v1/community/**/**/**").access("hasRole('ROLE_USER')")
