...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/check-username").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/check-email").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/community/meta/*/info").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/post/*").permitAll()
